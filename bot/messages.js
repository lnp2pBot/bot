...
var _a = require('../util'), getCurrency = _a.getCurrency, numberFormat = _a.numberFormat, getDetailedOrder = _a.getDetailedOrder, secondsToTime = _a.secondsToTime, getOrderChannel = _a.getOrderChannel, holdInvoiceExpirationInSecs = _a.holdInvoiceExpirationInSecs, sanitizeMD = _a.sanitizeMD, getEmojiRate = _a.getEmojiRate, decimalRound = _a.decimalRound, getUserAge = _a.getUserAge;
...
var nonHandleErrorMessage = function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, ctx.reply(ctx.i18n.t('non_handle_error'))];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
var invoicePaymentRequestMessage = function (ctx, user, request, order, i18n, buyer) { return __awaiter(void 0, void 0, void 0, function () {
    var currency, expirationTime, stars, roundedRating, rate, ageInDays, message, qrBytes, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
...
var pendingBuyMessage = function (bot, user, order, channel, i18n) { return __awaiter(void 0, void 0, void 0, function () {
    var orderExpirationWindow, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
var onGoingTakeBuyMessage = function (bot, seller, buyer, order, i18nBuyer, i18nSeller, rate) { return __awaiter(void 0, void 0, void 0, function () {
    var holdInvoiceExpiration, orderExpiration, time, expirationTime, ageInDays, error_26;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
...
var beginTakeSellMessage = function (ctx, bot, buyer, order) { return __awaiter(void 0, void 0, void 0, function () {
    var holdInvoiceExpiration, orderExpiration, time, expirationTime, error_27;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
var publishSellOrderMessage = function (ctx, user, order, i18n, messageToUser) { return __awaiter(void 0, void 0, void 0, function () {
    var publishMessage, channel, message1, error_36;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
...
var unavailableLightningAddress = function (ctx, bot, user, la) { return __awaiter(void 0, void 0, void 0, function () {
    var error_43;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, bot.telegram.sendMessage(user.tg_id, ctx.i18n.t('unavailable_lightning_address', { la: la }))];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
var showInfoMessage = function (ctx, user, config) { return __awaiter(void 0, void 0, void 0, function () {
    var status_1, node_uri, bot_fee, routing_fee, error_81;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                status_1 = config.node_status == 'up' ? '🟢' : '🔴';
                ...
                return [4 /*yield*/, ctx.telegram.sendMessage(user.tg_id, ctx.i18n.t('bot_info', { bot_fee: bot_fee, routing_fee: routing_fee, status: status_1, node_uri: node_uri }), {
                        parse_mode: 'MarkdownV2',
                    })];
            case 1:
                _a.sent();
...
var showConfirmationButtons = function (ctx, orders, commandString) { return __awaiter(void 0, void 0, void 0, function () {
    var inlineKeyboard, lastTwo, lineBtn, message, error_113;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
