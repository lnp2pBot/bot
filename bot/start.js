...
var OrderEvents = require('./modules/events/orders');
...
var _d = require('./commands'), rateUser = _d.rateUser, cancelAddInvoice = _d.cancelAddInvoice, addInvoice = _d.addInvoice, cancelShowHoldInvoice = _d.cancelShowHoldInvoice, showHoldInvoice = _d.showHoldInvoice, addInvoicePHI = _d.addInvoicePHI, cancelOrder = _d.cancelOrder, fiatSent = _d.fiatSent, release = _d.release;
var _e = require('../ln'), settleHoldInvoice = _e.settleHoldInvoice, cancelHoldInvoice = _e.cancelHoldInvoice, payToBuyer = _e.payToBuyer, subscribeInvoice = _e.subscribeInvoice, getInvoice = _e.getInvoice;
var _f = require('./validations'), validateUser = _f.validateUser, validateParams = _f.validateParams, validateObjectId = _f.validateObjectId, validateLightningAddress = _f.validateLightningAddress;
...
var askForConfirmation = function (user, command) { return __awaiter(void 0, void 0, void 0, function () {
    var orders, where, where, where, where, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                return [3 /*break*/, 8];
            case 6:
                if (!(command === '/setinvoice')) return [3 /*break*/, 8];
                where = {
                    $and: [
                        { buyer_id: user._id },
...
var initialize = function (botToken, options) {
    ...
    schedule.scheduleJob("*/20 * * * * *", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, messages.startMessage(ctx)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    bot.command('freezeorder', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!order)
                        return [2 /*return*/];
                    if (!!ctx.admin.admin) return [3 /*break*/, 7];
                    if (!!order.community_id) return [3 /*break*/, 5];
                    return [4 /*yield*/, messages.notAuthorized(ctx)];
                case 4: return [2 /*return*/, _a.sent()];
                case 5:
                    if (!(order.community_id != ctx.admin.default_community_id)) return [3 /*break*/, 7];
                    return [4 /*yield*/, messages.notAuthorized(ctx)];
                ...
                case 8:
                    ...
                    if (!order.secret) return [3 /*break*/, 10];
                    return [4 /*yield*/, settleHoldInvoice({ secret: order.secret })];
                case 9:
                    _a.sent();
                    _a.label = 10;
                case 10: return [4 /*yield*/, ctx.reply(ctx.i18n.t('order_frozen'))];
                case 11:
                    _a.sent();
                    return [3 /*break*/, 13];
                case 12:
    ...
    bot.command('cancelorder', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, order, dispute, buyer, seller, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    bot.command('cancel', userMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var params, _a, command, orderId, orders, error_8;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 10, , 11]);
    ...
    bot.command('cancelall', userMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orders, _i, orders_1, order, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
    ...
    bot.command('settleorder', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, order, dispute, buyer, seller, error_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 21, , 22]);
    ...
    bot.command('checkorder', superAdminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, order, buyer, seller, error_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
    ...
    bot.command('checkinvoice', superAdminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, order, invoice, error_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
    ...
    bot.command('resubscribe', superAdminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_13 = _a.sent();
                    logger.error("/resubscribe command error: ".concat(error_13.toString()));
                    return [3 /*break*/, 5];
    ...
    bot.command('fiatsent', userMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var params, _a, command, orderId, orders, error_16;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 10, , 11]);
    ...
    bot.command('ban', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var username, user, community, error_17;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    bot.command('unban', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var username, user_1, community, error_18;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 14, , 15]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    orders = _a.sent();
                    if (!!orders.length) return [3 /*break*/, 3];
                    return [4 /*yield*/, ctx.reply(ctx.i18n.t('setinvoice_no_response'))];
    ...
    bot.action(/^setinvoice_([0-9a-f]{24})$/, userMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (ctx.match === null) {
    ...
    bot.command('paytobuyer', adminMiddleware, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        var orderId, order, isPending, error_21;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 12, , 13]);
                ...
                case 4: return [2 /*return*/, _a.sent()];
                case 5:
                    if (!!ctx.admin.admin) return [3 /*break*/, 9];
                    if (!!order.community_id) return [3 /*break*/, 7];
                    return [4 /*yield*/, messages.notAuthorized(ctx)];
                case 6: return [2 /*return*/, _a.sent()];
                case 7:
                    if (!(order.community_id != ctx.admin.default_community_id)) return [3 /*break*/, 9];
                    return [4 /*yield*/, messages.notAuthorized(ctx)];
                case 8: return [2 /*return*/, _a.sent()];
                case 9: return [4 /*yield*/, PendingPayment.findOne({
                        order_id: order._id,
